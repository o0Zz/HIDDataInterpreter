...
{
	HIDReportDescriptor hid_report_descriptor(report_data, (uint16_t)sizeof(report_data));
	GTEST_ASSERT_EQ(hid_report_descriptor.get_reports()[0].inputs[0].data.size(), 26);
	GTEST_ASSERT_EQ(hid_report_descriptor.get_reports()[0].inputs[0].data[0].type, HIDIOType::ReportId);
	GTEST_ASSERT_EQ(hid_report_descriptor.get_reports()[0].inputs[0].data[1].type, HIDIOType::Z);
	GTEST_ASSERT_EQ(hid_report_descriptor.get_reports()[0].inputs[0].data[2].type, HIDIOType::Rz);
	GTEST_ASSERT_EQ(hid_report_descriptor.get_reports()[0].inputs[0].data[3].type, HIDIOType::X);
	GTEST_ASSERT_EQ(hid_report_descriptor.get_reports()[0].inputs[0].data[4].type, HIDIOType::Y);
